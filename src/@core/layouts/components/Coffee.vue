...
export default {
  ...
  data() {
    return {
      erc20: '0xfB14E4726c3b293B0319137b7B5B1c203e0b5D56',
      selectedAddress: 'cosmos14xr759mpd7pr4mjk58jv6yqdg4tyn8m0c8qmxf',
    }
  },
  computed: {
    chains() {
      const { data } = addressDecode('cosmos14xr759mpd7pr4mjk58jv6yqdg4tyn8m0c8qmxf')
